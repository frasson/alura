...
public class SubscriberSelector {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*Selector
         * é necessário setar essa propriedade no momento que a mensagem é produzida
         * A ultima propriedade indica se queremos ou não receber mensagens produzidas pela mesma conexão*/
